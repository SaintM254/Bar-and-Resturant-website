...
export default function DishModal({ dish, onClose }: DishModalProps) {
  ...
  return (
    ...
    >
      {/* Backdrop (fixed so it covers the screen even while scrolling) */}
      <div
        className={`fixed inset-0 bg-[rgba(24,16,8,0.68)] transition-opacity duration-300 ${
      ...
      {/* Centering wrapper: scrolls instead of clipping on short screens */}
      <div className="relative flex min-h-full items-center justify-center p-4 sm:p-6">
        {/* Panel */}
        <div
          className={`relative my-auto w-full max-w-[560px] border border-line bg-ivory transition-all duration-300 ${
        ...
        >
          ...
          {/* Photo height is capped to the screen, so the whole card fits */}
          <div className="aspect-[4/3] max-h-[42vh] w-full overflow-hidden bg-cream">
            <img
              src={current.img}
