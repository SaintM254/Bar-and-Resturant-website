...
- Set `ADMIN_PASSWORD` and `ALLOWED_ORIGIN=https://your-site-url`.
- Bookings live in `server/data/*.json` — back that folder up.
- Outgrowing JSON files? Replace `src/db.js` with SQLite/Postgres; nothing else changes.
